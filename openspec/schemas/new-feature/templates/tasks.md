...
- [ ] 2.1 <!-- TODO: Task description. If tied to a Scenario ID, add/update tests whose title includes [SCENARIO_ID]. -->
- [ ] 2.2 <!-- TODO: Task description. Prefer order: implementation -> tests -> refactor -> docs update. -->
