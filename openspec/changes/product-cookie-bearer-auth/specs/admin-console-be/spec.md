...
- **GIVEN** request が有効な Product bearer token を持つが Admin credential、`X-Auth-Context-Id`、operator session record、Admin CSRF binding を持たない
