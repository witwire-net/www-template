    ...
    <Card class="w-full">
      <CardContent>
        <div class="auth-card">
          ...
          <h1 class="auth-card__title">{data.state.sentView.title}</h1>
          <p class="auth-card__desc">{data.state.sentView.description}</p>
          <p class="auth-card__desc">{data.state.sentView.helper}</p>
