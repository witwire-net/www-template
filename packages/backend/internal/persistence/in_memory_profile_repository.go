...
func (r *InMemoryProfileRepository) List(context.Context) ([]domain.Profile, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *InMemoryProfileRepository) GetByID(_ context.Context, id int64) (domain.Profile, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *InMemoryProfileRepository) Create(_ context.Context, input domain.CreateProfileInput) (domain.Profile, error) {
	r.mu.Lock()
	defer r.mu.Unlock()
