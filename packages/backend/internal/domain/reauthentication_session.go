...
func NewReauthenticationSession(id string, accountID string, issuingSessionID string, operationKind string, requestID string, expiresAt time.Time) (ReauthenticationSession, error) {
...
func ReconstituteReauthenticationSession(id string, accountID string, issuingSessionID string, operationKind string, requestID string, expiresAt time.Time, consumedAt *time.Time) (ReauthenticationSession, error) {
...
func (s ReauthenticationSession) AccountID() string { return s.accountID }
