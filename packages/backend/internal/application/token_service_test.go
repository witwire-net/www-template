...
func (m *mockRefreshTokenStore) RevokeAllForFingerprint(_ context.Context, accountID domain.AccountID, fingerprint string) error {
	m.revokedFP = append(m.revokedFP, accountID.String()+":"+fingerprint)
	return nil
}

func (m *mockRefreshTokenStore) RevokeBySessionID(_ context.Context, accountID domain.AccountID, sessionID string) error {
	m.revokedSID = append(m.revokedSID, accountID.String()+":"+sessionID)
	return nil
}
...
func (m *mockSessionStore) SaveSession(_ context.Context, sessionID string, _ domain.AccountID, metadata SessionMetadata, _ time.Duration) error {
...
func (m *mockSessionStore) ListSessions(_ context.Context, _ domain.AccountID) ([]SessionMetadata, error) {
...
func (m *mockSessionStore) RevokeSession(_ context.Context, _ domain.AccountID, sessionID string) error {
	delete(m.sessions, sessionID)
	return nil
}

func (m *mockSessionStore) RevokeOthers(_ context.Context, _ domain.AccountID, currentSessionID string) ([]string, error) {
...
func (m *mockSessionStore) RevokeAllForAccount(_ context.Context, _ domain.AccountID) error {
	for id := range m.sessions {
		delete(m.sessions, id)
	}
	return nil
