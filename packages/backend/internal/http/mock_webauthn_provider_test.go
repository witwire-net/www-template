...
func (m *mockWebAuthnProvider) FinishLogin(_ context.Context, _ string, credential usecases.WebAuthnAssertionCredentialDTO,
...
func (m *mockWebAuthnProvider) FinishRegistration(_ context.Context, _ string, _ string, credential usecases.WebAuthnAttestationCredentialDTO) (string, domain.WebAuthnCredentialData, error) {
	handle := credential.ID
	if handle == "" {
